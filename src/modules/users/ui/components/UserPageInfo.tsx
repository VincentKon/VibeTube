    ...
    <div className="py-6">
      <div className="flex flex-col md:hidden">
        <div className="flex items-center gap-3">
          <Skeleton className="h-[60px] w-[60px] rounded-full"></Skeleton>
          <div className="flex-1 min-w-0">
            <Skeleton className="h-6 w-32"></Skeleton>
            <Skeleton className="h-4 w-48 mt-1"></Skeleton>
          </div>
        </div>
        <Skeleton className="h-10 w-full mt-3 rounded-full"></Skeleton>
      </div>
      <div className="hidden md:flex items-start gap-4">
        <Skeleton className="h-[160px] w-[160px] rounded-full"></Skeleton>
        <div className="flex-1 min-w-0">
          <Skeleton className="h-8 w-64"></Skeleton>
          <Skeleton className="h-5 w-48 mt-4"></Skeleton>
          <Skeleton className="h-10 w-32 mt-3 rounded-full"></Skeleton>
        </div>
      </div>
    </div>
  );
